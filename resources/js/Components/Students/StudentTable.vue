            ...
            <table class="w-full min-w-160">
                ...
                <thead>
                    <tr class="border-b border-table-grid bg-table-header">
                        <th
                            class="px-3 py-2.5 text-left text-[10px] font-semibold tracking-wider text-sidebar/70 uppercase sm:px-4 sm:py-3 sm:text-[11px] sm:tracking-widest lg:px-5 lg:py-3.5">
                            Student
                        </th>
                        <th
                            class="px-2.5 py-2.5 text-left text-[10px] font-semibold tracking-wider text-sidebar/70 uppercase sm:px-3 sm:py-3 sm:text-[11px] sm:tracking-widest lg:px-4 lg:py-3.5">
                            Student ID
                        </th>
                        <th
                            class="px-2.5 py-2.5 text-left text-[10px] font-semibold tracking-wider text-sidebar/70 uppercase sm:px-3 sm:py-3 sm:text-[11px] sm:tracking-widest lg:px-4 lg:py-3.5">
                        ...
                        <th
                            class="px-2.5 py-2.5 text-right text-[10px] font-semibold tracking-wider text-sidebar/70 uppercase sm:px-3 sm:py-3 sm:text-[11px] sm:tracking-widest lg:px-4 lg:py-3.5">
                            Action
                        </th>
                    </tr>
                </thead>
                    ...
                    <tr v-if="rows.length === 0">
                        <td colspan="6" class="p-0">
                            <div class="flex h-48 flex-col items-center justify-center gap-2 sm:h-56 sm:gap-3 lg:h-64">
                                <div
                                    class="flex h-12 w-12 items-center justify-center rounded-full bg-sidebar/10 sm:h-14 sm:w-14">
                                ...
                                <p class="text-[11px] text-gray-300 sm:text-xs">Try adjusting your search or filter
                                    options</p>
                            </div>
                        </td>
                    </tr>
