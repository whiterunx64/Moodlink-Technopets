...
<template>
    <div class="flex flex-wrap items-center gap-1.5 sm:gap-2">
        <button
            ...
            :class="[
                'inline-flex cursor-pointer items-center gap-1.5 rounded-lg border px-2.5 py-1.5 text-xs font-semibold transition-all duration-150 sm:gap-2 sm:rounded-xl sm:px-4 sm:py-2.5 sm:text-sm',
