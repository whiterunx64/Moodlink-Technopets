...
<template>
    <div class="flex items-center justify-between flex-wrap gap-3">
        ...
        <button type="button" @click="emit('export')"
            class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium border border-border-light bg-white text-text-secondary hover:bg-gray-50 transition-colors">
