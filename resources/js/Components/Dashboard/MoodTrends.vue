...
<template>
    <article
        class="border-border-light my-9 flex h-full flex-col rounded-2xl border bg-white shadow-sm md:my-0"
    ...
    >
        ...
        >
            ...
            <div
                class="bg-post-card-bg flex rounded-full p-1"
                role="group"
        ...
        <div class="flex items-center justify-between px-5 pt-4">
            <div
                class="grid flex-1 grid-cols-3 overflow-hidden rounded-lg bg-stone-200/70"
            >
                <button
                    v-for="p in PERIODS"
                    :key="p"
        ...
        >
            <div
                ...
                :key="bar.label"
                class="bg-post-card-bg flex items-center gap-2 rounded-xl px-3 py-2"
                role="listitem"
            >
                <span
