...
const displayedAppointments = computed(() => {
    if (activeTab.value !== 'requests' && activeTab.value !== 'scheduled') {
        return [...props.appointments].reverse();
    }
...
<template>
    ...
    <AdminLayout title="Appointments">
        ...
        <pre
            v-if="checkInDebug"
            class="mb-4 overflow-auto rounded-lg bg-gray-900 p-3 text-xs text-green-300"
        >
        ...
        <div class="items-start gap-6 md:flex">
            ...
            >
                ...
                <div class="shrink-0 border-b border-gray-100 px-4 py-3">
                    <div
                        class="flex w-fit max-w-full gap-0.5 overflow-x-auto rounded-xl bg-gray-100 p-1"
                    >
                        <button
                            v-for="tab in TABS"
                            :key="tab.key"
                ...
                <div v-else class="flex-1 space-y-2 overflow-y-auto p-4">
                    <div
                        v-for="apt in displayedAppointments"
                        :key="apt.id"
                        class="group flex min-h-20 flex-col gap-4 rounded-xl border border-gray-100 bg-gray-50 px-4 py-4 transition-all duration-200 hover:border-gray-200 hover:bg-white hover:shadow-sm md:flex-row md:items-center"
                    >
                        ...
                        <div class="flex shrink-0 items-center gap-2">
                            <template v-if="activeTab === 'requests'">
                                <button
                                    type="button"
                                    class="flex-1 rounded-lg border border-gray-200 px-3 py-1.5 text-xs font-semibold text-gray-500 transition-colors hover:border-red-200 hover:bg-red-50 hover:text-red-500 md:flex-none"
                                ...
                                <button
                                    type="button"
                                    class="bg-sidebar hover:bg-sidebar/90 flex-1 rounded-lg px-3 py-1.5 text-xs font-semibold text-white transition-colors md:flex-none"
                            ...
                            <template v-else-if="activeTab === 'scheduled'">
                                <div
                                    class="flex w-full flex-col items-start gap-2 md:items-end"
                                >
                                    <span
                                    ...
                                    <div class="flex w-full gap-2">
                                        <button
                                            ...
                                            "
                                            class="flex flex-1 items-center gap-1.5 rounded-lg border border-amber-200 px-3 py-1.5 text-xs font-semibold text-amber-600 transition-colors hover:bg-amber-50 disabled:cursor-not-allowed disabled:border-gray-200 disabled:text-gray-400 disabled:hover:bg-transparent md:flex-none"
                                        ...
                                        <button
                                            ...
                                            class="flex flex-1 items-center gap-1.5 rounded-lg border border-dashed border-gray-300 px-3 py-1.5 text-xs font-semibold text-gray-500 transition-colors hover:bg-gray-50 md:flex-none"
            ...
            <div
                class="mb-6 flex h-[calc(100vh-16rem)] w-full shrink-0 flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm md:w-72"
            >
