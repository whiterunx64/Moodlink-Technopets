...
<template>
    <div class="font-inter min-h-screen bg-[#eceae6] flex items-center justify-center px-3 py-8 md:px-4 md:py-12">
        ...
        <div
            class="w-full max-w-108 flex rounded-2xl overflow-hidden shadow-2xl sm:max-w-132 md:max-w-200 md:rounded-3xl lg:max-w-232 xl:max-w-264">

            <div
                class="hidden md:flex flex-col items-center justify-center bg-[#2d5016] p-10 w-[44%] shrink-0 text-center lg:p-14">
                <div class="mb-5 flex items-center justify-center rounded-3xl border border-white/10 p-6 lg:mb-6 lg:p-8"
                    style="background: rgba(255,255,255,0.03); box-shadow: 0 4px 24px rgba(0,0,0,0.12), 0 1px 4px rgba(0,0,0,0.08), inset 0 1px 0 rgba(255,255,255,0.06);">
                    <img :src="logoUrl" alt="MoodLink" class="h-24 w-24 lg:h-32 lg:w-32"
                        style="filter: drop-shadow(0 12px 24px rgba(0,0,0,0.5)) drop-shadow(0 4px 8px rgba(0,0,0,0.3));" />
                </div>
                <div class="font-montserrat text-3xl font-black text-white tracking-tight mb-2 lg:text-4xl">MoodLink
                </div>
            ...
            <div
                class="flex-1 bg-white px-6 py-8 flex flex-col justify-center sm:px-8 sm:py-10 md:px-12 md:py-14 lg:px-14">
                <h2 class="font-montserrat text-2xl font-bold text-gray-900 mb-1.5 sm:text-3xl">Sign In</h2>
                <p class="font-inter text-sm text-gray-400 mb-8 sm:text-base sm:mb-10">Use your provided MoodLink
                    credentials</p>

                <form @submit.prevent="submit" class="space-y-5 sm:space-y-6">
                    <div>
                        <label for="email"
                            class="font-inter block text-xs font-semibold text-gray-600 uppercase tracking-widest mb-2.5">
                            Email Address
                        </label>
                    ...
                    <div>
                        <div class="mb-2.5">
                            <label for="password"
                                class="font-inter text-xs font-semibold text-gray-600 uppercase tracking-widest">
                                Password
                            </label>
                        </div>
                        <div class="relative">
