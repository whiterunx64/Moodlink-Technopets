            ...
            <div v-else class="space-y-6">
                ...
                <div class="grid grid-cols-4 gap-4">
                    <StatCard
                        ...
                        :color="card.color"
                        :change="card.change"
                        :change-up="card.changeUp"
                    />
                </div>

                <div class="flex-row gap-6 md:flex md:h-136">
                    <div
                        class="border-border-light flex h-full flex-1 flex-col rounded-2xl border bg-white shadow-sm"
                    >
                        <div
                ...
                >
                    <div
                        class="border-border-light flex items-center justify-between border-b px-5 pt-5 pb-4"
                    >
                    ...
                    <div
                        class="divide-border-light flex h-128 flex-col divide-y overflow-y-auto"
                    >
                        <div
